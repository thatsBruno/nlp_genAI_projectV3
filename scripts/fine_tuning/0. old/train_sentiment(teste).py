...
if __name__ == '__main__':
    ...
    # ==== 1. Define paths ====
    train_path = "/home/sagemaker-user/Proj_NPA/nlp_genAI_projectV2/data/processed/edmunds_chat_sentiment_train.jsonl"
    test_path  = "/home/sagemaker-user/Proj_NPA/nlp_genAI_projectV2/data/processed/edmunds_chat_sentiment_test.jsonl"
    output_dir = "/home/sagemaker-user/Proj_NPA/nlp_genAI_projectV2/models/sentiment_model"
    ...
    # Simplificado, SEM os argumentos incompatíveis:
    training_args = TrainingArguments(
        output_dir=output_dir,
        num_train_epochs=args.epochs,
        per_device_train_batch_size=args.batch_size,

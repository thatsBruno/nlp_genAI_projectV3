...
previsao_path = os.path.expanduser("~/Proj_NPA/nlp_genAI_projectV3/data/processed/resultados_finetuning.csv")
output_path = os.path.expanduser("~/Proj_NPA/nlp_genAI_projectV3/data/processed/merged_finetuning.csv")

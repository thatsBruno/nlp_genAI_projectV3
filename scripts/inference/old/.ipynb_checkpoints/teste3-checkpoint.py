...
# Zero-shot
zero_shot_action = [
    "You are a customer service agent. Based on the following car review, decide the single most appropriate next action to take (for example: 'Apologize to the customer', 'Offer a refund', 'Thank the customer', 'Request more information').\n"

...
# === CONFIGURAÇÕES ===
CSV_PATH = os.path.expanduser("~/Proj_NPA/nlp_genAI_projectV3/data/raw/edmunds-car-ratings.csv")
#N_REVIEWS_BATCH = 100
N_FEW_SHOT = 3
REGION = "eu-west-1"
...
df_resultados.to_csv("~/Proj_NPA/nlp_genAI_projectV3/data/processed/resultados_base.csv", index=False)
print("✅ Resultados gravados em 'resultados_base.csv'")